...
# שימוש ב‑python -m gunicorn כגיבוי אם ה־entrypoint לא נמצא ב‑PATH
CMD ["python", "-m", "gunicorn", "--bind", "0.0.0.0:8080", "bot:app", "--workers", "2", "--timeout", "30"]
